...
On the left we have the visualisation of the daily profile of mean response time through the year per season. While on the right, we look at the response time as a categorical variable with it having two levels: less than 8 minutes and more than 8 minutes and look at at its distribution for snowy days, season, rain and hour of day.
