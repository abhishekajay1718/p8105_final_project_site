...
*  [This](https://www.ncbi.nlm.nih.gov/pubmed/29381111) study done in California county early this year challenges the commonly held assumption that ambulances are later to poor neighborhoods. So we thought the relationship in emergency response time between a economically well off area - Upper West Side and a relatively poorer area such as Washington Heigths would be interesting to investigate. 
